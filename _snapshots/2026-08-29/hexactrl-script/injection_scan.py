...
def injection_scan(i2csocket,daqsocket,clisocket,basedir,device_name,injectionConfig,logging_level='INFO'):
    ...
    odir = "%s/%s/injection_scan/run_%s/"%( os.path.realpath(basedir), device_name, timestamp ) # a comlete path is needed
    os.makedirs(odir)
