...
#    dev.getNode("clk_FC_mux.FC_int_select").write(0x1)
    ...
    print("External clk active:", dev.getNode("clk-mux-clk-mux-0.clk_ext_active").read())
    print("Internal clk select:", dev.getNode("clk-mux-clk-mux-0.clk_int_select").read())
    #print("Internal cmd select:", dev.getNode("clk-mux-clk-mux-0.FC_int_select").read())
    print("clk40_ext_rate:", dev.getNode("clk-mux-clk-mux-0.clk40_ext_rate").read())
